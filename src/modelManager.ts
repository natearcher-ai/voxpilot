...
const MODEL_REGISTRY: Record<string, ModelInfo> = {
  ...
  'whisper-tiny': {
    name: 'Whisper Tiny (90+ languages)',
    size: '~120MB',
    files: [
      'onnx/encoder_model.onnx',
      'onnx/decoder_model_merged.onnx',
  ...
  'whisper-base': {
    name: 'Whisper Base (90+ languages)',
    size: '~200MB',
    files: [
      'onnx/encoder_model.onnx',
      'onnx/decoder_model_merged.onnx',
  ...
  'whisper-small': {
    name: 'Whisper Small (90+ languages)',
    size: '~600MB',
    files: [
      'onnx/encoder_model.onnx',
      'onnx/decoder_model_merged.onnx',
  ...
  'whisper-medium': {
    name: 'Whisper Medium (90+ languages)',
    size: '~1.5GB',
    files: [
      'onnx/encoder_model.onnx',
      'onnx/decoder_model_merged.onnx',
  ...
  'whisper-large-v3-turbo': {
    name: 'Whisper Large v3 Turbo (90+ languages)',
    size: '~1.6GB',
    files: [
      'onnx/encoder_model.onnx',
      'onnx/decoder_model_merged.onnx',
